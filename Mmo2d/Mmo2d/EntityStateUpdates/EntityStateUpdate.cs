        ...
        public bool ContainsInformation
        {
            get
            {
                return Displacement.HasValue || Died.HasValue || Jumped.HasValue || AttackInitiated.HasValue ||
                    ...
                    StartCastFrostbolt.HasValue || AutoAttack.HasValue || Remove.HasValue || Add != null || 
                    ApplyChill.HasValue || ApplyFreeze.HasValue || Blink.HasValue;
            }
        }
    }
}

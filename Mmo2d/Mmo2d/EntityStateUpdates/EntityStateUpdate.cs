...
namespace Mmo2d.EntityStateUpdates
{
    public class EntityStateUpdate
    {
        ...
        public bool? ApplyChill { get; set; }
        public bool? ApplyFreeze { get; set; }
        ...
        public bool ContainsInformation
        {
            get
            {
                return Displacement.HasValue || Died.HasValue || Jumped.HasValue || AttackInitiated.HasValue ||
                    ...
                    SetTargetId.HasValue || DeselectTarget.HasValue || StartCastFireball.HasValue || StartCastFrostbolt.HasValue || AutoAttack.HasValue || Remove.HasValue || Add != null || ApplyChill.HasValue || ApplyFreeze.HasValue;
            }
        }
    }
}
